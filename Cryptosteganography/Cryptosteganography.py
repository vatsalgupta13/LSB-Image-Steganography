...
import base64 #provides functions to encode binary data to Base64 encoded format and decode such encodings back to binary data
import hashlib #provides an interface to most popular hashing algorithms
import getpass #prompts the user for password
